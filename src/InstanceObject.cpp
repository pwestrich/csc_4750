...
void InstanceObject::render(const Matrix4 &transform, const Matrix4 &windowingMatrix, const Vector4 &eyepoint, const float attenuation) const {

	//tell the BasicObject to render with the instance transform
	parent->render(transform * instanceTransform, windowingMatrix, eyepoint, material, attenuation);
